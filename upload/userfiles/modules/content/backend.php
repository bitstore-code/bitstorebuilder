                    ...
                    <div class="tree-show-hide-nav">
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                ...
                                <label class="custom-control-label d-flex align-items-center" for="open-close-all-tree-elements"><small class="text-muted"><?php _e("Close"); ?> / <?php _e("Open"); ?></small></label>
                            </div>
                        </div>
