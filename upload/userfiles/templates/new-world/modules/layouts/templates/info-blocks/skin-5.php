    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-10 mx-auto">
                <div class="row">
                    <div class="order-2 order-xl-2 text-center text-sm-center text-lg-left col-md-10 mx-auto col-lg-7 m-b-20 d-flex flex-column justify-content-center align-items-center">
                    ...
                    <div class="order-1 order-xl-1 text-left text-sm-center text-xl-left col-lg-5 m-b-20">
